...
### Visit https://ast-pap-kanban-board.netlify.app
...
3. Install pnpm globally by running `npm i pnpm -g`
4. Navigate to the main folder of the project within your terminal
5. Run `pnpm i`
6. Run `pnpm run dev`
