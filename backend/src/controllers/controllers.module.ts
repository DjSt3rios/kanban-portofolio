...
import { BlColumnModule } from '../business-logic/bl-column/bl-column.module';

@Module({
  imports: [UserModule, AuthModule, ColumnModule, CardModule, BoardGatewayModule, BlCardModule, BlColumnModule],
